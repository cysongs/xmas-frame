...
import { vars } from "/var/task/ui";
import { devtools } from "frog/dev";
import TreeMain from "/var/task/tree-view";
import CreateTree from "/var/task/create-tree";
import PATH from "/var/task/routes/path";
import CreateTx from "/var/task/create-tree/createTx";
import DecorateTree from "/var/task/decorate";
import HomePage from "/var/task/main/main";
import DecorateConfirm from "/var/task/decorate/confirm";
import AdornTx from "/var/task/decorate/adornTx";
