...
const _abi = [
  ...
  },
  {
    ...
    outputs: [
      {
        internalType: "contract IXmasNFT",
        name: "",
        type: "address",
      },
    ],
    ...
    inputs: [
      {
        ...
        internalType: "struct IXmasTree.Background[]",
        name: "bgs",
        type: "tuple[]",
      },
    ],
    ...
    inputs: [
      {
        ...
        internalType: "struct IXmasTree.Ornament[]",
        name: "os",
        type: "tuple[]",
      },
    ],
    name: "registerOrnaments",
    outputs: [],
    stateMutability: "nonpayable",
    type: "function",
  },
